				...
				<div class="os">
					<div class="row g1 content-middle">
						...
						<div class="os-min text-center">
							...
							<input type="checkbox" name="menu[][target]" class="margy1" value="1" <? if ( $menu['target'] ) {
								echo "checked";
							} ?>>
						</div>
					</div>
			...
			<div class="os-3">
				<div class="autosticky rf_menu_links section">
					...
					foreach ( $pts as $type ) {
						...
						?>
						<div class="accordion_handle pad1 menu_header <? if ( ! $notfirst ) {
							echo "toggled";
						} ?>" data-accordion=".<?= $type['slug']; ?>">
							<?= $type['label_plural']; ?>
						</div>
						<div class="accordion <? if ( $notfirst ) {
							echo "collapsed";
						} ?> <?= $type['slug']; ?> pad1">
							<?
