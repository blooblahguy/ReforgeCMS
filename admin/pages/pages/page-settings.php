...
class admin_page_SETTINGS extends RF_Admin_Page {
	...
	function edit( $args ) {
		...
		$home_page = $home_page != null ? $home_page : "";
		$disable_seo = $disable_seo != null ? $disable_seo : "";
		$seo_seperator = $seo_seperator != null ? $seo_seperator : "";
		$seo_keywords = $seo_keywords != null ? $seo_keywords : "";
		$sitename = $sitename != null ? $sitename : "";
		$default_role = $default_role != null ? $default_role : "";
