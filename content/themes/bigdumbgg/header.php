...
<head>
	...
	<link href="https://fonts.googleapis.com/css2?family=Roboto:ital@0;1&family=Teko:wght@500;800&display=swap" rel="stylesheet">
			...
			<div class="header container">
				<div class="row content-middle">
					<h1 class="os-min marg0">
						<a href="/" class="logo"><?= get_file_contents_url(theme_url()."/img/bdgg.svg"); ?>BDG</a>
					</h1>
					<?
