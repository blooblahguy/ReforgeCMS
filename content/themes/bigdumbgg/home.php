					...
					<div class="stream_nav row g1">
						<? foreach ( $all as $k => $stream ) {
							...
							<div class="os-12 os-md-4 os-lg-3">
								<a href="#<? echo $stream['user_login']; ?>" id="<? echo $stream['user_login']; ?>" class="streamer_tab<? if ( $k == 0 ) {
										  echo " active";
									  } ?>">
									<div class="row g1 content-middle">
										...
										<div class="os-min">
											<span class="live_icon">
												<xml version="1.0" encoding="utf-8" ?><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 122.88 122.88" xml:space="preserve">
														<g>
